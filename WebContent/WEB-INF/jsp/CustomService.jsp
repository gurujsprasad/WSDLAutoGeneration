				...
				<div style = "padding: 31px 10px 0;">
					...
					<div class="header">
							...
							<form action = "CustomService" method = "post">
									...
									<input type = "text" name = "op1" value="Enter Service URL" id = "op1" onblur="this.value=!this.value?'Enter Service URL':this.value;" onfocus="this.select()" onclick="this.value='';"/>
								
								
									<input type = "text" name = "op2" value="Repeation" id = "op2" onblur="this.value=!this.value?'Repeation':this.value;" onfocus="this.select()" onclick="this.value='';"/>
								
									<input type = "submit" value = "Run Service" id="submit" />
